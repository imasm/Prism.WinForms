...
using Prism.Mvvm;
using Prism.WinForms.Tests.Mocks.ViewModels;
using Prism.WinForms.Tests.Mocks.Views;
...
namespace Prism.WinForms.Tests
{
    [TestClass]
    public class BootstrapperFixture
    {
        ...
        {
            var serviceLocator = new Prism.WinForms.Tests.ServiceLocatorExtensionsFixture.MockServiceLocator(() => new MockViewModel());
