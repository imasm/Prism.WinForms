...
namespace Prism.WinForms.Tests.Modularity
{
    [TestClass]
    public class DirectoryModuleCatalogFixture
    {
        ...
        {
            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockModuleA.cs",
            ...
            StringAssert.Contains(modules[0].ModuleType, "Prism.WinForms.Tests.Mocks.Modules.MockModuleA");
        }
        ...
        {
            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockDependencyModule.cs",
                                       ModulesDirectory3 + @"\DependencyModule.dll");

            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockDependantModule.cs",
        ...
        public void ShouldLoadAssemblyEvenIfTheyAreReferencingEachOther()
        {
            ...
            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockModuleReferencingOtherModule.cs",
...
#pragma warning restore 0618
        ...
        {
            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockExposingTypeFromGacAssemblyModule.cs",
        ...
        {
            CompilerHelper.CleanUpDirectory(ModulesDirectory1);
            CompilerHelper.CompileFile(@"Prism.WinForms.Tests.Mocks.Modules.MockAbstractModule.cs",
